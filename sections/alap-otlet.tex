...
\begin{frame}{Az algoritmus alapötlete 2.}
  ...
  \begin{enumerate}
    ...
    \item A mélységi bejárás alapján minden csúcshoz határozzuk meg a szülejét, valamint a belépési (IN[v]) és kilépési (OUT[v]) sorszámait.
    ...
    \item Hajtsunk végre úttömörítést (path compression), hogy kihagyjuk azon élek bejárását, amelyekhez már találtunk csereélet.
  \end{enumerate}
