...
\begin{frame}{Az algoritmus alapötlete 2.}
  ...
  \begin{enumerate}
    ...
    \item A mélységi bejárás alapján minden csúcsnak rendeljük hozzá a szülőjét, valamint a belépési és kilépési sorszámát.
    ...
    \item Hajtsunk végre útkompresziót (path compression), hogy kihagyjuk azon élek bejárását, amelyenek már találtunk csereélet.
  \end{enumerate}
  A diszjunkt halmaz adatszerkezetet használjuk gyors útkompresszióra a Gabow-Tarjan-féle statikus uniófa módszer alapján.
\end{frame}