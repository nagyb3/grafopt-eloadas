\begin{frame}{Példa lefutás: első nem-fa él $(g, e)$ (3.)}
\begin{columns}[T]
  \begin{column}{0.46\textwidth}
    ...
    \begin{itemize}
      ...
      \item PathLabel(e, g, (e, g))
      \item A fordított (e, g) éllel PathLabel hívás nem fog feldolgozódni, mivel e őse g-nek.
    \end{itemize}
    % \vspace{0.5em}
    % \textbf{Következmény:}
    % \begin{itemize}
