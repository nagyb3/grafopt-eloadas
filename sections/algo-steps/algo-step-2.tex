...
% ====================================================================
% Példa lefutás – (e,g) él, 1. dia: MST + DFS + nem-fa él
% ====================================================================
\begin{frame}{Példa lefutás - első nem-fa él $(e,g)$}
\begin{columns}[T]
  \begin{column}{0.46\textwidth}
    \small
    \textbf{Első nem-fa él: $(e, g)$}
    \begin{itemize}
      % \item Adott az MST (vastag élek) és a DFS alapján kiosztott $\text{IN}, \text{OUT}$ számok.
      % \item Vizsgáljuk a legkisebb súlyú nem-fa élet: \alert{$(e,g)$}, súlya $6$.
      ...
      \item Az e él g élnek a felmenője a fában, így megkapjuk $plan = ANCESTOR$-t. Továbbá $k_1$ = IN[e] = 4 és $k_2$ = IN[g] = 6, és mivel $k_1$ < $k_2$ ezért elkezdjük a bejárást.
      ...
      \item A kör bejárás g-nél kezdjük. Mivel g-t még nem jártuk be (link(g) = g), ezért a (g, e) nem-MST élet (g, h) csereéleként mentjük el ($R(g, h) = (e, g)$).
