...
\begin{columns}[T]
  \begin{column}{0.46\textwidth}
    ...
    \begin{itemize}
      ...
      \item RIGHT plan-t kapjuk meg. $k_1$ = OUT[g], $k_2$ = IN[b], szóval $k_1$ < $k_2$.
      ...
      \item A bejárást b-vel kezdjük és mivel b-t még nem látogattuk meg ezért (b, e) él a a (b, g) nem-MST élt kapja meg csereélként.
      % \item The disjoint set is linked (line 15) so b’s disjoint set gets e’s label and the subpath (b,e) is compressed.
      \item b és e diszjunkt halmazait link-eljük. A (b, e) subpath compressed lesz.
    \end{itemize}
  \end{column}
