\begin{frame}{Példa lefutás - második nem-fa él $(b-g)$}
\begin{columns}[T]
  \begin{column}{0.46\textwidth}
    ...
    \begin{itemize}
      ...
      \item A következő él a bejárásban e (mivel ő b-nek a szülője), így k2 = IN[e]. Ekkor $k_2$ < $k_1$ teljesül, így leáll a while loop.
      % \item The oppositely-oriented edge (g,b) is input at line 34.
      \item Meghívjuk PathLabel-t (g-b) éllel: PathLabel(g, b, (g, b)).
      % \item We get the LEFT branch plan (line 8) with k1 = OUT[g], k2 = IN[b] so k1 < k2 and start the traversal with g.
      \item Megkapjuk LEFT ágtervet, $k_1$ = OUT[g] és $k_2$ = IN[b]-vel, szóval $k_1$ < $k_2$ és megkezdjük a bejárást g-vel kezdve.
      ...
      \item Ekkor figyeljük meg, hogy a diszjunkt halmazok tömörítették már a (g, h, e) részútat, ezért find(g) != g. ... 
    \end{itemize}
  \end{column}
