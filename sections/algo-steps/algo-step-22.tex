...
\begin{columns}[T]
  \begin{column}{0.46\textwidth}
    ...
    \begin{itemize}
      ...
      \item A következő él a bejárásban e (mivel ő b-nek a szülője), így k2 = IN[e]. Ekkor k2 < k1 teljesül, így leáll a while loop.
      ...
      \item Megkapjuk LEFT ágtervet, k1 = OUT[g] és k2 = IN[b]-vel, szóval k1 < k2 és megkezdjük a bejárást g-vel kezdve.
