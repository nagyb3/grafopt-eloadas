...
\draw[mstedge] (c) -- (d)
  node[midway, left=2pt, fill=white, inner sep=1pt, font=\scriptsize]{7};
\draw[mstedge] (a) -- (d)
  node[midway, left=2pt, fill=white, inner sep=1pt, font=\scriptsize]{9};
\draw[mstedge] (e) -- (h)
...
\draw[otheredge] (a) -- (b)
  node[midway, above=2pt, fill=white, inner sep=1pt, font=\scriptsize]{10};
\draw[otheredge] (c) -- (e)
