\begin{frame}{Példa lefutás: első nem-fa él $(g, e)$ (2.)}
\begin{columns}[T]
  \begin{column}{0.46\textwidth}
    \small
    \textbf{Első nem-fa él $(g, e)$:} (folyt.)
    \begin{itemize}
      ...
      \item A követekező csúcs a bejárásban h lesz, mivel ő g szülője (find(g) = h). $k_2$-t frissítjük IN[h]-vel. (IN[h] = 5)
      ...
      \item A bejárásban e lesz a következő csúcs, szóval $k_2$ megkapja IN[e]-t (= 4), már egyenlő lesz $k_1$-el (= 4), ezzel leállítva a bejárást (kilépünk a while ciklusből).
    \end{itemize}
  \end{column}
