...
\begin{frame}{PathLabel funkciója}
  \begin{itemize}
    ...
    \item s éllel kezdve végig lépked a fán és:
    \begin{itemize}
      \item Ha az adott él még nem volt path compression-elve (v = find(v)), akkor annak az élnek az inputként megadott élet menti el csereélének. Majd path compression-t hajt végre (link(v)).
      \item $k_1$ és $k_2$ counter-eket léptetgeti, ameddig végig nem érünk az s -> t úton.
    \end{itemize}
  \end{itemize}
\end{frame}